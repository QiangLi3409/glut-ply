...
void SavePLYfile(char filename[],unsigned int *triangleIndexList,std::vector<JAMESDATA> drawData,int numTriangleVertices,float thershold=0.)
{
	...
	for (i=0; i<numTriangleVertices; i+=3)  
	{
		   ...
		   int id2 = triangleIndexList[i+2];   
		   int id3 = triangleIndexList[i+3];   
		   // comptute disttance 
		   float dist[3];
